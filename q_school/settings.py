"""
Django settings for q_school project.
...
SECRET_KEY = 'django-insecure-=nlm!p!nszqrn2-li=*cdi^-8*&b5343jj@9c_s+%arf=!g$n4'
...
WSGI_APPLICATION = 'q_school.wsgi.application'
...
ip = socket.gethostbyname(os.environ.get('POSTGRES_DB'))
